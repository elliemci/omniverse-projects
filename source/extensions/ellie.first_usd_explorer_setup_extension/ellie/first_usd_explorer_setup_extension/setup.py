...
ICON_PATH = carb.tokens.get_tokens_interface().resolve("${ellie.first_usd_explorer_setup_extension}/data/icons")
...
class SetupExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id: str):
        ...
        self._layouts_path = carb.tokens.get_tokens_interface().resolve("${ellie.first_usd_explorer_setup_extension}/layouts")
    ...
    def _custom_quicklayout_menu(self):
        ...
        def add_layout_menu_entry(name, parameter, key):
            ...
            layouts_path = carb.tokens.get_tokens_interface().resolve("${ellie.first_usd_explorer_setup_extension}/layouts")
